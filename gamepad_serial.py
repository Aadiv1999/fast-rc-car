...
class XINPUT_GAMEPAD(ctypes.Structure):
    _fields_ = [
        ...
        ('r_thumb_x', ctypes.c_short),  # sThumbLX
        ('r_thumb_y', ctypes.c_short),  # sThumbLY
        ('l_thumb_x', ctypes.c_short),  # sThumbRx
        ('l_thumb_y', ctypes.c_short),  # sThumbRy
    ]
...
def sample_first_joystick(thisisit):
    """
    ...
    def on_axis(axis, value):
        ...
        #             j.set_vibration(0, 0)
        #         else:
        #             j.set_vibration(0.5, 0)
        #     elif axis == "right_trigger":
        #         right_speed = value
        #         if value == 0:
        #             j.set_vibration(0, 0)
        #         else:
        #             j.set_vibration(0, 0.5)
        #     else:
        #         j.set_vibration(0, 0)
    ...
    # /print(a)
    # time.sleep(.01)
        # print(whichButton,howMuch)

    return whichAxis, howMuch
...
if __name__ == "__main__":
    ...
    while True:
        ...
        axis, value = sample_first_joystick(yes)

        if axis != '' and axis != 'r_thumb_x':

            if not (axis == prevAxis and value == prevValue):
                ser.write((str(axis)+str(value)+'\n').encode())
                print("Command: ",(str(axis)+str(value)), " Value: ",value)
